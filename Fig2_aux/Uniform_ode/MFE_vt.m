...
global tau taus zeta eta_k J sig2 n M Ns Mt njt;
...
for nv=1:n
    anj=y((nv-1)*M+njt.',1); % spektralines amplitudes;
    Wr(nv,1)=anj.'*Mt;
end
if n==1
    W=1+2*Wr; % the case of Cauchy heterogeneity;
else
W=1-2*1i*sin(pi/2/n)*zeta.'*Wr; % the general case of flat heterogeneity;
end
