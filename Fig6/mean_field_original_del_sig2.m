% Normal-type distribution of heterogeinity etav
...
del=0.26; % half width at half maximum (HWHM);
...
%wm0=zeros(2*n+1,1); % initial condition;
 a1=1*rand(n,1)-1i*rand(n,1);
 a2=a1.^2;
 wm0=[a1;a2;0]; % initial condition;
...
save('mean_field_original_del_sig2.mat','t','r'); % recording the dynamics r(t) 
...
dydt3=(-wm(2*n+1)+r)/taus; % synaptic equation
