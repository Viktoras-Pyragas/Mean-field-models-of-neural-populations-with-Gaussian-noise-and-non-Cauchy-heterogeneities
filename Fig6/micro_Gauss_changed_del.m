...
sig2=0.02; % Gaussian noise amplitude (original)
sig=sqrt(2*sig2);
del0=0.31; % half-width (corresponds to del=d) (changed)
d=del0;
...
load('init_cond_micro_changed_del.mat', 'tet','s'); % loading initial conditions;
...
save('micro_changed_del.mat','tm','rm'); % recording time series of the solution;
%-----------------------------------------------------------------------------------------
save('init_cond_micro_changed_del.mat', 'tet','s'); % recording final state of the system;
