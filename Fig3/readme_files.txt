...
% n=10 (flat heterogeneity distribution), and for microscopic - the rectangular 
...
%-------------------------------------------------------------------------------
% micro_Rect_original_del_sig2.m -> integrates the microscopic equations for original parameters [del,sig2];
%-------------------------------------------------------------------------------
% micro_Rect_changed_del.m -> integrates the microscopic equations for changed parameter del;
%-------------------------------------------------------------------------------
% micro_Rect_changed_sig2.m -> integrates the microscopic equations for changed parameter sig2;
%-------------------------------------------------------------------------------
...
%-------------------------------------------------------------------------------
% tight_subplot_v.m -> % plotting the general graph;
%-------------------------------------------------------------------------------
