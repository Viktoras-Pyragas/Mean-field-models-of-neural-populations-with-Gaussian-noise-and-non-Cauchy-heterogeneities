...
% relaxation equation: dS/dt=(-S+R)/taus;
%------------------------------------------------------------------
% ksi_b.m -> % this function computes the poles ksi_j of normal distribution of normal heterogeneity,
% and the expansion coefficients b_j
%------------------------------------------------------------------
% biff_Hopf_v.m -> plots the bifurcation diagram for n=2;
%------------------------------------------------------------------
