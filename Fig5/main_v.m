...
% J=2.0;
%----------------------------------------------------------------------
load('Xn1_Nek_J2.mat','X_Gd');
Xt1=X_Gd(:,1:2);
load('Xn2_Nek_J2.mat','X_Gd');
Xt2=X_Gd(:,1:2);
load('Xn4_Nek_J2.mat','X_Gd');
Xt4=X_Gd(:,1:2);
load('Xn6_Nek_J2.mat','X_Gd');
Xt6=X_Gd(:,1:2);
%----------------------------------------------------------------------
...
% J=3.0;
%----------------------------------------------------------------------
load('Xn1_Nek_J3.mat','X_Gd');
Xt1p=X_Gd(:,1:2);
load('Xn2_Nek_J3.mat','X_Gd');
Xt2p=X_Gd(:,1:2);
load('Xn4_Nek_J3.mat','X_Gd');
Xt4p=X_Gd(:,1:2);
load('Xn6_Nek_J3.mat','X_Gd');
Xt6p=X_Gd(:,1:2);
%----------------------------------------------------------------------
% Result from Fourier components:
% J=3.0;
...
% J=4.0;
%----------------------------------------------------------------------
load('Xn1_Nek_J4.mat','X_Gd');
Xt1w=X_Gd(:,1:2);
load('Xn2_Nek_J4.mat','X_Gd');
Xt2w=X_Gd(:,1:2);
load('Xn4_Nek_J4.mat','X_Gd');
Xt4w=X_Gd(:,1:2);
load('Xn6_Nek_J4.mat','X_Gd');
Xt6w=X_Gd(:,1:2);
%----------------------------------------------------------------------
% Result from Fourier components:
% J=4.0;
...
% J=5.0;
%----------------------------------------------------------------------
load('Xn1_Nek_J5.mat','X_Gd');
Xt1k=X_Gd(:,1:2);
load('Xn2_Nek_J5.mat','X_Gd');
Xt2k=X_Gd(:,1:2);
load('Xn4_Nek_J5.mat','X_Gd');
Xt4k=X_Gd(:,1:2);
load('Xn6_Nek_J5.mat','X_Gd');
Xt6k=X_Gd(:,1:2);
%----------------------------------------------------------------------
% Result from Fourier components:
% J=5.0;
...
% circle; triangle; square (coordinates);
  Psw=[[0.02; 0.26], [0.05; 0.26], [0.02; 0.31]]; 
...
plot(Xt4(:,1),Xt4(:,2),'-','color',kc*[1 1 1],'LineWidth',mb1);
...
plot(xq4,vq4,':b','LineWidth',mbs);
plot(xq6,vq6,'-r','LineWidth',mbs);
%---------------------------------------------------------------------
xlim([xmn xmx]);
ylim([ymn ymx]);
%---------------------------------------------------------------------
...
plot(Xt4p(:,1),Xt4p(:,2),'-','color',kc*[1 1 1],'LineWidth',mb1);
...
plot(Xt4w(:,1),Xt4w(:,2),'-','color',kc*[1 1 1],'LineWidth',mb1);
...
legend('MF (n=1,2,4,6)','','','',' "exact" (n=1)',' "exact" (n=2)',' "exact" (n=4)',' "exact" (n=6)','Position',pos_leg_v,'FontSize',nfk);
hold off
...
plot(Xt4k(:,1),Xt4k(:,2),'-','color',kc*[1 1 1],'LineWidth',mb1);
